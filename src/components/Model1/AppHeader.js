function AppHeader() {
    return (
        <header id="header1">
            <a id="logo" href="/model1"><svg width="197" height="201" viewBox="0 0 197 201" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav className="mobile-menu">
                ...
                <ul>
                    ...
                    <li><a href="#highlights">Favoritos</a></li>
                    <li><a href="#body">Corpo</a></li>
                    <li><a href="#hair">Cabelo</a></li>
                    <li><a href="#skincare">Skincare</a></li>
                    <li><a href="#make">Maquiagem</a></li>
                    <li><a href="#gloss">Gloss</a></li>
                    <li><a href="#footer1">Contato</a></li>
                </ul>
            </nav>
            <a id="whatsapp" href="https://wa.me/559193405570?text=Ol%C3%A1,%20gostaria%20de%20fazer%20um%20pedido"
                target="_blank" rel="noopener noreferrer"><ion-icon name="logo-whatsapp"></ion-icon>WhatsApp</a>
